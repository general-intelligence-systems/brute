{
  ...
  brute = {
    dependencies = ["activesupport" "async" "async-http-faraday" "colorize-extended" "diff-lcs" "file-tail" "gem_kit" "google-protobuf" "json_schemer" "net-http-persistent" "rack"];
    groups = ["default"];
    platforms = [];
    source = {
      path = ./.;
