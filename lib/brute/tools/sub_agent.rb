...
module Brute
  module Tools
    ...
    # completion middleware passes it to the LLM as a regular tool; when
    # invoked, the SubAgent runs its own pipeline against a fresh Session
    # built from the tool arguments, then returns the final assistant
    ...
    class SubAgent < Agent
      ...
      # sees this as a regular tool. ToolCall middleware should call
