...
#   tools  — examples/grafana_agent/tools.rb (the upstream tool set;
#            PromQL suggestion logic ported from internal/promql)
#   skills — examples/grafana_agent/.brute/skills/**/SKILL.md (upstream's
...
#   bundle exec ruby examples/grafana_agent/agent.rb \
