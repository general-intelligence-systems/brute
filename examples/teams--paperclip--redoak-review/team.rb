...
# RedOak Review — a team of agents, ported from paperclipai/companies
# (companies/redoak-review).
#
...
ci_integration_engineer = member("ci-integration-engineer",
           "CI/CD Integration Engineer — You receive assignments from the CEO / Lead " \
           "Reviewer when a team wants to automate their review pipeline. This " \
           "typically means setting up GitHub Actions workflows that trigger the " \
           "appropriate review agents on PR events.")

code_reviewer = member("code-reviewer",
           "Senior Code Reviewer — You receive review assignments from the CEO / " \
           "Lead Reviewer, typically a PR diff, a branch, or specific files flagged " \
           "for code quality analysis.")

design_reviewer = member("design-reviewer",
           "Senior Design Reviewer — You receive review assignments from the CEO / " \
           "Lead Reviewer, typically a deployed URL, a local development server, or " \
           "a PR that includes frontend/UI changes.")

security_reviewer = member("security-reviewer",
           "Senior Security Reviewer — You receive review assignments from the CEO / " \
           "Lead Reviewer, typically a PR diff, a branch, or specific files flagged " \
           "for security analysis.")

TEAM = [ci_integration_engineer, code_reviewer, design_reviewer, security_reviewer].freeze

# The CEO / Lead Reviewer's prompt is the company description (COMPANY.md body)
