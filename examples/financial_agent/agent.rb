...
#            example
#   tools  — examples/financial_agent/tools.rb (dexter's finance tools as
#            plain hashes; no tool library)
#   skills — examples/financial_agent/.brute/skills/**/SKILL.md
#
# Usage:
#   export FINANCIAL_DATASETS_API_KEY=...   # https://financialdatasets.ai
#   export ANTHROPIC_API_KEY=...
#   bundle exec ruby examples/financial_agent/agent.rb "How did NVDA's margins trend over the last 3 years?"
