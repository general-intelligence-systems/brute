...
# Run it three ways:
#
#   ruby examples/agents/08_checkpoints.rb                        # fresh turn
#   BRUTE_CHECKPOINT=latest ruby examples/agents/08_checkpoints.rb
#   BRUTE_CHECKPOINT=<id from the printed chain> ruby examples/agents/08_checkpoints.rb
#
# Defaults to a local Ollama (see docker-compose.yml). Override with env vars:
#   BRUTE_PROVIDER=anthropic BRUTE_MODEL=claude-opus-4-8 ANTHROPIC_API_KEY=... ruby examples/agents/08_checkpoints.rb
...
CHECKPOINT_PATH = File.join(__dir__, "tmp", "checkpoints_08.jsonl")
