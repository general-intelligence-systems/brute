...
#   tools  — examples/agents/browser_agent/tools.rb (the upstream tool set;
#            upstream's Read/Write/Edit file tools map to brute's own
#            FSRead/FSWrite/FSPatch)
#   skills — examples/agents/browser_agent/.brute/skills/**/SKILL.md (upstream's
...
#   bundle exec ruby examples/agents/browser_agent/agent.rb \
