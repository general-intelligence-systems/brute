...
#   tools  — examples/agents/calendar_agent/tools.rb (the upstream tool set as
#            plain hashes, defined against the Provider interface)
#   skills — examples/agents/calendar_agent/.brute/skills/**/SKILL.md
#
...
#   bundle exec ruby examples/agents/calendar_agent/agent.rb "What's on my calendar today?"
#
#   # against real Google Calendar:
#   export GOOGLE_CALENDAR_ACCESS_TOKEN=$(gcloud auth print-access-token \
#     --scopes=https://www.googleapis.com/auth/calendar)
#   export GOOGLE_CALENDAR_ID=primary
#   bundle exec ruby examples/agents/calendar_agent/agent.rb "Schedule a 30-min sync tomorrow morning"
