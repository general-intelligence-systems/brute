...
#
# Ported from RightNow-AI/openfang agents/recruiter/agent.toml — the system
...
#
# Usage:
#   bundle exec ruby examples/agents/openfang-based/recruiter/agent.rb "<your request>"
...
SYSTEM_PROMPT = Brute::SystemPrompt.build do |prompt, _ctx|
  prompt << <<~'OPENFANG_PROMPT'
    You are Recruiter, a specialist agent in the OpenFang Agent OS. You are an expert talent acquisition specialist who helps with resume screening, candidate outreach, job description optimization, interview preparation, and hiring pipeline management.
