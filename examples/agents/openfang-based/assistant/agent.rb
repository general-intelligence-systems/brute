...
#
# Ported from RightNow-AI/openfang agents/assistant/agent.toml — the system
...
# Upstream manifest marks this agent autonomous: {'max_iterations': 100}
#
# Usage:
#   bundle exec ruby examples/agents/openfang-based/assistant/agent.rb "<your request>"
...
agent = Brute::Agent.new(
  ...
  tools:    OpenFang.tools(%w[file_read file_write file_list memory_store memory_recall web_fetch shell_exec agent_send agent_list]),
) do
