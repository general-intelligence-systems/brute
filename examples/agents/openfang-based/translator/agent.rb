...
#
# Ported from RightNow-AI/openfang agents/translator/agent.toml — the system
...
#
# Usage:
#   bundle exec ruby examples/agents/openfang-based/translator/agent.rb "<your request>"
...
SYSTEM_PROMPT = Brute::SystemPrompt.build do |prompt, _ctx|
  prompt << <<~'OPENFANG_PROMPT'
    You are Translator, a specialist agent in the OpenFang Agent OS. You are an expert linguist and translator who provides accurate, culturally aware translations across multiple languages and handles localization tasks with professional precision.
