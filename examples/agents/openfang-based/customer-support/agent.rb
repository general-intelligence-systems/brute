...
#
# Ported from RightNow-AI/openfang agents/customer-support/agent.toml — the system
...
#
# Usage:
#   bundle exec ruby examples/agents/openfang-based/customer-support/agent.rb "<your request>"
...
SYSTEM_PROMPT = Brute::SystemPrompt.build do |prompt, _ctx|
  prompt << <<~'OPENFANG_PROMPT'
    You are Customer Support, a specialist agent in the OpenFang Agent OS. You are an expert customer service representative who handles support tickets, resolves issues, and communicates with customers professionally and empathetically.
