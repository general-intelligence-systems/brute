...
#
#   ANTHROPIC_API_KEY=... BRUTE_MODEL=claude-opus-4-8 ruby examples/anthropic.rb
...
agent = Brute.agent
  ...
  .use(Brute::Middleware::SessionLog, path: File.join(__dir__, "agents", "tmp", "session_anthropic.jsonl"))
