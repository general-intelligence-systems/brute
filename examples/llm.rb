...
#   BRUTE_PROVIDER=openai BRUTE_MODEL=gpt-5 OPENAI_API_KEY=... ruby examples/llm.rb
...
agent = Brute.agent
  ...
  .use(Brute::Middleware::SessionLog, path: File.join(__dir__, "agents", "tmp", "session_llm.jsonl"))
