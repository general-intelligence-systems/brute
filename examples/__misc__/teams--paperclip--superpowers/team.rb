...
# Superpowers Dev Shop — a team of agents, ported from paperclipai/companies
# (companies/superpowers).
#
...
code_reviewer = member("code-reviewer",
           "Senior Code Reviewer — You receive completed implementations from the " \
           "Lead Engineer — a branch with changes, a summary, and the original plan " \
           "to review against.")

lead_engineer = member("lead-engineer",
           "Lead Software Engineer — You receive implementation plans from the CEO. " \
           "Each plan contains bite-sized tasks with exact file paths, code, and " \
           "verification steps.")

release_engineer = member("release-engineer",
           "Release Engineer — You receive approved, reviewed branches from the Code " \
           "Reviewer.")

TEAM = [code_reviewer, lead_engineer, release_engineer].freeze
