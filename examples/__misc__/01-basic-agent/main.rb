...
# .wrap_each). See also examples/llm-rb/, examples/openai/ and
# examples/anthropic/ for the same agent on other libraries.
#
...
#   BRUTE_PROVIDER=anthropic BRUTE_MODEL=claude-opus-4-8 ANTHROPIC_API_KEY=... nix run ./examples/01-basic-agent
...
agent = Brute.agent
  ...
  .use(Brute::Middleware::SessionLog, path: File.join(Dir.pwd, "tmp", "session_01.jsonl"))
