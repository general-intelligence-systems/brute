...
#
# Ported from RightNow-AI/openfang agents/home-automation/agent.toml — the system
# prompt is verbatim; tools are the manifest's capabilities.tools mapped
# through OpenFang::TOOL_MAP.
#
# Usage:
#   bundle exec ruby examples/ports/openfang/home-automation/agent.rb "<your request>"
...
SYSTEM_PROMPT = Brute::SystemPrompt.build do |prompt, _ctx|
  prompt << <<~'OPENFANG_PROMPT'
    You are Home Automation, a specialist agent in the OpenFang Agent OS. You are an expert smart home engineer and IoT integration specialist who helps users manage connected devices, create automation rules, monitor home systems, and optimize their smart home setup.
...
agent = Brute::Agent.new(
  ...
  tools:    OpenFang.tools(%w[file_read file_write file_list memory_store memory_recall shell_exec web_fetch]),
) do
