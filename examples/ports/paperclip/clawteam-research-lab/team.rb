...
# ClawTeam Research Lab — a team of agents, ported from paperclipai/companies
# (companies/clawteam-research-lab).
#
...
data_analyst = member("data-analyst",
           "Data Analyst — You receive experiment execution tasks that unblock after " \
           "the Methodology Designer completes experiment plans. The plans specify " \
           "exactly what to run, measure, and compare.")

literature_surveyor = member("literature-surveyor",
           "Literature Surveyor — You receive survey assignments from the Principal " \
           "Investigator via ClawTeam tasks. Each assignment specifies a research " \
           "area or question to investigate.")

methodology_designer = member("methodology-designer",
           "Methodology Designer — You receive experiment design tasks from the " \
           "Principal Investigator, informed by the Literature Surveyor's gap " \
           "analysis. Your tasks typically unblock after the literature review is " \
           "complete.")

TEAM = [data_analyst, literature_surveyor, methodology_designer].freeze

# The Principal Investigator & CEO's prompt is the company description (COMPANY.md body)
